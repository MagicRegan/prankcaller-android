...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel_Factory(Provider<PrankRepository> repositoryProvider) {
  ...
  public static HomeViewModel_Factory create(Provider<PrankRepository> repositoryProvider) {
    return new HomeViewModel_Factory(repositoryProvider);
  }

  public static HomeViewModel newInstance(PrankRepository repository) {
